...
public class DataSet {
    ...
    public static List<String> namesList(){
        return List.of("Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill",
                "Rick","Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick",
                "Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick",
                "Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill",
                "Rick","Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick",
                "Bob", "Jamie", "Jill", "Rick","Bob", "Jamie", "Jill", "Rick");
